...
if e then
    ...
    local function runLoader(g)
        ...
        elseif j.code == 'KEY_HWID_LOCKED' then
            return false, 'HWID locked. Reset via bot.'
    ...
    local function promptKey()
        ...
        v.RichText = true
        v.Text = '<font color="#ffffff">day</font><font color="#b284d6">dreamer.</font>'
        v.TextSize = 14
        v.Font = j
        v.Parent = m
        ...
        z.MouseButton1Click:Connect(function()
            ...
            if E and #E > 0 then
                ...
                w.PlaceholderText = 'key cannot be empty'
                w.PlaceholderColor3 = Color3.fromRGB(255, 100, 100)
            end
        end)
